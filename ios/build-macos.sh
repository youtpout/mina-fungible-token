...
# 2. Form defaults, from the repository-root .env.local, the same file and the
#    same keys the Gradle build reads. The values land inside the binary, so
#    only throwaway Devnet keys belong there.
...
generated="$here/Sources/Defaults.generated.swift"
{
  echo "// Generated by ios/build-macos.sh from .env.local — do not edit."
  echo "enum Defaults {"
